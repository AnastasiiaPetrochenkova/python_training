...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, title=None, company=None,
                 ...
                 email1=None, email2=None, email3=None, id=None, all_phones_from_home_page=None, all_emails_from_home_page=None):
    ...
    def __repr__(self):
        return "%s:%s:%s:%s:%s:%s:%s:%s:%s:%s" % (self.firstname, self.lastname, self.address, self.id, self.home_phone, self.work_phone, self.mobile_phone, self.email1, self.email2, self.email3)
